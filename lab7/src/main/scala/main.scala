      ...
      argmap.get("io") match
        case None => 
          (argmap.get("input"), argmap.get("output")) match
            ...
            case (_,_) => run_tasks(tasks, "input", "output")
        case Some(value) =>
...
def run_tasks(tasks: String, input: String, output: String) =
  tasks.split("").foreach { key =>
    ...
    case "1" =>{
      println("Variant 1")
      println("Question 4")
      var1.task1.test(input, output)
    }
    case "2" => {
      println("Variant 1")
      println("Question 5")
      var1.task2.test(input, output)
    }
    case "3" => {
      println("Variant 2")
      println("Question 4")
      var2.task1.test(input, output)
    }
    case "4" => {
      println("Variant 2")
      println("Question 5")
      var2.task2.test(input, output)
    }
    case "5" => {
      println("Variant 3")
      println("Question 4")
      var3.task1.test(input, output)
    }
    case "6" => {
      println("Variant 3")
      println("Question 5")
      var3.task2.test(input, output)
    }
    case "7" => {
      println("Variant 4")
      println("Question 4")
      var4.task1.test(input, output)
    }
    case "8" => {
      println("Variant 4")
      println("Question 5")
      var4.task2.test(input, output)
    }
